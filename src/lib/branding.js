...
export const brandClassNames = {
  iconFrame:
    "shrink-0 overflow-hidden rounded-2xl border border-emerald-100 bg-white shadow-sm ring-1 ring-white/70",
  ...
  wordmarkSecondary:
    "shrink-0 font-semibold italic text-emerald-700 antialiased",
};
